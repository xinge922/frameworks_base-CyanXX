...
/*final String[] Gan = new String[] { "甲", "乙", "丙", "丁", "戊", "己", "庚",
	 ...
	 * @return
	 */
	public Lunar(Context ctx, Calendar cal) {
		int yearCyl;
		int monCyl=0;
		int dayCyl;
		int leapMonth = 0;
	    ...
	    chineseNumber = ctx.getResources().getStringArray(R.array.chinese_month);
        /*{ "正", "二", "三", "四", "五", "六", "七",
			"八", "九", "十", "十一", "腊" };
            */
	    chineseNumber1 = ctx.getResources().getStringArray(R.array.chinese_month1);
        /*{ "一", "二", "三", "四", "五", "六", "七",
			"八", "九", "十", "十一", "十二" }; */
        chineseTen = ctx.getResources().getStringArray(R.array.chinese_ten);
        
        chn_ten = ctx.getResources().getString(R.string.chn_ten);
        chn_double = ctx.getResources().getString(R.string.chn_double);
        Gan = ctx.getResources().getStringArray(R.array.chinese_gan);
        Zhi = ctx.getResources().getStringArray(R.array.chinese_zhi);
	...
	public String toString() {
		return (leap ? chn_double : "") + chineseNumber[month - 1] 
	...
	public static void main(String[] args) throws ParseException {
		...
		today.setTime(chineseDateFormat.parse("1987年10月7日"));//加载自定义日期
