...
public class PiePolicy {
    ...
    public static String getWifiSsid() {
        String ssid = mContext.getString(R.string.pie_wifi_not_connected);
        ...
        if (networkInfo.isConnected()) {
            ...
            ssid = mContext.getString(R.string.pie_mobile_data_title);
        }
    ...
    private final void updateDataNetType(int net) {
        boolean mShowFourG = false; // old phones won't do 4G
    ...
    public static String getNetworkProvider() {
        String operatorName = mContext.getString(R.string.pie_wifi_no_network);
