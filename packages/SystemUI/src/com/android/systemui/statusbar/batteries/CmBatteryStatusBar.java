...
public class CmBatteryStatusBar extends ProgressBar implements Animatable, Runnable {

    private static final String TAG = CmBatteryStatusBar.class.getSimpleName();
    ...
    public CmBatteryStatusBar(Context context) {
        this(context, null);
    }

    public CmBatteryStatusBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CmBatteryStatusBar(Context context, AttributeSet attrs, int defStyle) {
