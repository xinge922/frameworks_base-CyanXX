 ...
 * {@hide}
 */
public class SEMC7X27RIL extends RIL implements CommandsInterface {
    public SEMC7X27RIL(Context context) {
        super(context);
    }

    public SEMC7X27RIL(Context context, int networkMode, int cdmaSubscription) {
